    ...
    $.fn.stepform = function (options) {
        ...
        return this.each(function () {
            ...
            function buildNavigation(count) {
                ...
                var $elem = '<div class="">';
                // $this.nav.append('<div class="">')
                for (let i = 1; i <= count; i++) {
                    $elem += "<span data-navstep='" + i + "'></span>";
                }
                $elem += '</div>';
            ...
            function validateField($elem) {
                ...
                if (validate == "email") {
                    ...
                    var minVal = $elem.data('min-value');
                    var maxVal = $elem.data('max-value');
                    if (valueLength == 0) {
                        hasError = true;
                    } else if (valueLength < minVal) {
                        hasError = true;
                        errorMsg = "Needs to be minimum of " + minVal + " characters";
                    } else if (valueLength > maxVal) {
                        hasError = true;
                        errorMsg = "Needs to be maximum of " + maxVal + " characters";
                    }
                }
                ...
                //    hasError = true;
                //    if ($elem.data('validate') > 1)
                //        errorMsg = "Needs to be maximum of " + maxLength + " characters";
                //}
