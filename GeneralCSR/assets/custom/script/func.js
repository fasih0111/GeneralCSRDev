function runTooltipsterAjax(elem, actionName, data, afterCallMethod) {

    var $loadElem = '<div class="loader-container"><div class="loader"></div></div>';
    ...
    $(elem).tooltipster({
            ...
            if ($origin.data('loaded') !== true) {
                $.ajax({
                    ...
                    success: function (response) {
                        if (afterCallMethod != "") afterCallMethod(response, instance); $origin.data('loaded', true);
        ...
        functionPosition: function (instance, helper, position) {
            position.coord.left = instance._$origin.offset().left - 2;
            return position;
        }
    });
}
