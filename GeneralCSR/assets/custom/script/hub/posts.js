    ...
    if (data.length > 0) {
        ...
        if (data[0].FollowCount > 0) {
            ...
            if ($me.find(".comment-count").text().length > 0 || $me.find(".archive-count").text().length > 0) {
                $me.find(".actions-count .dot-space:first").html("&nbsp;&nbsp;&#8226;&nbsp;&nbsp;");
            }
...
generalHub.client.setCommentSupport = function (data) {
    ...
    var $obj = $("ul.comments > li[data-id='" + data[0].RefID + "'] .support-count");
...
generalHub.client.setCommentEndorse = function (data) {
    ...
    var $objMain = $("ul.comments > li[data-id='" + data[0].RefID + "']");
    var $obj = $("ul.comments > li[data-id='" + data[0].RefID + "'] .endorse-count");
