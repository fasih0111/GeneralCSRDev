...
namespace Models
{
    public class DALPosts
    {
        ...
        public virtual DataRow InsertUpdatePosts(BALPosts BAL, string Offset, string Next)
        {
            SqlParameter[] param = {
        ...
        public virtual DataTable GetStarredComments(string UserID)
        {
            SqlParameter[] param = {
                                       new SqlParameter("@UserID", UserID)
                               };
            return SqlHelper.ExecuteDataTable(FCommon.ConStr, CommandType.StoredProcedure, "spGetStarredComments", param);
        }

        public virtual DataTable InactivePost(string MyID, string PostID, bool IsActive)
        {
            SqlParameter[] param = {
                                       new SqlParameter("@MyID", MyID),
