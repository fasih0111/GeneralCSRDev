...
namespace Models
{
    public class DALUsers
    {
        ...
        public virtual DataTable GetUsers(string UserID, string UserName, string Email)
        {
            SqlParameter[] param = {
                                   new SqlParameter("@UserID", UserID),
            ...
            return SqlHelper.ExecuteDataTable(FCommon.ConStr, CommandType.StoredProcedure, "spGetUsers", param);
        }
        ...
        public virtual DataRow ChangePassword(string Email, string Pass)
        {
            SqlParameter[] param = {
                                   new SqlParameter("@Email", Email),
                                   new SqlParameter("@Pass", Pass)
            ...
            bool IsExpert, string Address, DateTime DOB, bool Gender, string Expertise)
        {
            SqlParameter[] param = {
                                   new SqlParameter("@UserID", UserID),
                                   new SqlParameter("@DescribeID", DescribeID),
                                   new SqlParameter("@UserBrief", UserBrief),
                                   new SqlParameter("@IsExpert", IsExpert),
